							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<form class="form-horizontal form-label-left" method="POST"
										id="form" action="/admin/phone/create"
										enctype="multipart/form-data">
										<div class="row text-left">
											<div class="col-md-4">
												<div class="form-group ">
													<label class="control-label">Tên</label> <input type="text"
														class="form-control" name="NAME" /> <span id="NAME_error"
														class="text-danger"></span>
												</div>
												<!-- Hãng -->
												<div class="form-group">
													<label class="control-label">Hãng</label> <select
														name="brand.ID" id="brand" class="form-select">
													...
													</select> <span id="brand_errors" class="text-danger"></span>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													<label class="control-label">Hệ điều hành</label> <select
														name="system.ID" id="system" class="form-select">
													...
													</select> <span id="system_errors" class="text-danger"></span>
												</div>
												<div class="form-group">
													<label class="control-label">Cổng sạc</label> <select
														name="charging_port.ID" id="charging_port"
														class="form-select">
													...
													</select> <span id="charging_port_errors" class="text-danger"></span>
												</div>
												<div class="form-group">
													<label class="control-label">Cổng tai nghe</label> <select
														name="headphone_jack.ID" id="headphone_jack"
														class="form-select">
													...
													</select> <span id="headphone_jack_errors" class="text-danger"></span>
												</div>
												<div class="form-group">
													<label class="control-label">Loại pin</label> <select
														name="battery_type.ID" id="battery_type"
														class="form-select">
													...
													</select> <span id="battery_type_errors" class="text-danger"></span>
												</div>
												<div class="form-group">
													...
													</select> <span id="screen_resolution_errors" class="text-danger"></span>
												</div>
												<div class="form-group">
													<label class="control-label">Chip đồ họa</label> <select
														name="graphics_chip.ID" id="graphics_chip"
														class="form-select">
													...
													</select> <span id="graphics_chip_errors" class="text-danger"></span>
												</div>
												<div class="form-group ">
													<label class="control-label">Chip</label> <input
														name="PROCESSOR" type="text" class="form-control" /> <span
														id="PROCESSOR_error" class="text-danger"></span>
												</div>
												<div class="form-group ">
													<label class="control-label">Quay video</label> <input
														name="VIDEO_RECORDING" type="text" class="form-control" />
													<span id="VIDEO_RECORDING_error" class="text-danger"></span>
												</div>
												<div class="form-group ">
													<label class="control-label">Kết nối</label> <input
														name="CONNECTION" type="text" class="form-control" /> <span
												...
												<div class="form-group ">
													<label class="control-label">Kích thước độ phân
														giải</label> <input name="SCREEN_RESOLUTIONKT" type="text"
														class="form-control" placeholder="" /> <span
														id="SCREEN_RESOLUTIONKT_error" class="text-danger"></span>
												</div>
											...
											<div class="col-md-4">
												<div class="form-group ">
													<label class="control-label">Chiều rộng(mm)</label> <input
														min="0" max="300" name="WIDTH" type="number" step="any"
														class="form-control" /> <span id="WIDTH_error"
														class="text-danger"></span>
												</div>
												<div class="form-group ">
												...
												<div class="form-group ">
													<label class="control-label">Kích thước màng
														hình(inch)</label> <input name="SCREEN_SIZE" type="number"
														min="0" max="12"
														step="any" class="form-control" /> <span
														id="SCREEN_SIZE_error" class="text-danger"></span>
												</div>
												<div class="form-group ">
												...
												<div class="form-group ">
													<label class="control-label">Ram</label> <input name="RAM"
														min="0" max="10"
														type="number" step="any" class="form-control" /> <span
											...
											<div class="col-md-4">
												<div class="form-group">
													<img id="previewImg1" alt="" height="100px" width="100px"
														...
														class="form-control"
														onchange="previewImage(this, 'previewImg1')"> <span
														id="anh_error" class="text-danger"></span>
												</div>
												<div class="form-group">
													<img id="previewImg2" alt="" height="100px" width="100px"
														src=""> <label class="control-label">Ảnh2</label> <input
										...
										<c:forEach items="${list_phone}" var="item" varStatus="stt">
											<tr class="center">
												...
												<td class="pt-5 cochu">PD<fmt:formatDate
														value="${item.CREATE_AT}" pattern="yyyyMMdd" />${stt.index +1 }</td>
												...
												<td class="text-center pt-5"><i
													...
													data-bs-target="#updatephone${item.ID}"></i> <i
													...
													<div class="modal fade" id="updatephone${item.ID}"
														tabindex="-1" aria-labelledby="updatephoneLabel"
														aria-hidden="true">
														<div class="modal-dialog modal-xl">
															<div class="modal-content">
																<div class="modal-header">
																	...
																	<form class="form-horizontal form-label-left"
																		...
																		<div class="row text-left">
																			<div class="col-md-4">
																				...
																				<div class="form-group">
																					<label class="control-label">Hãng</label> <select
																						name="brand.ID" id="brands" class="form-select">
																						<option value="">Chọn hãng sản phẩm</option>
																						<c:forEach items="${list_brand}" var="entry">
																							<option value="${entry.key}"
																				...
																				<div class="form-group">
																					<label class="control-label">Hệ điều hành</label> <select
																						name="system.ID" id="systems" class="form-select">
																						<option value="">Chọn hệ điều hành</option>
																						<c:forEach items="${list_system}" var="entry">
																							<option value="${entry.key}"
																				...
																				<div class="form-group">
																					<label class="control-label">Cổng sạc</label> <select
																						name="charging_port.ID" id="charging_ports"
																						class="form-select">
																						<option value="">Chọn cổng sạc</option>
																						<c:forEach var="entry"
																				...
																				<div class="form-group">
																					...
																					<select name="headphone_jack.ID"
																						id="headphone_jacks" class="form-select">
																						<option value="">Chọn cổng tai nghe</option>
																						<c:forEach var="entry"
																				...
																				<div class="form-group">
																					<label class="control-label">Loại pin</label> <select
																						name="battery_type.ID" id="battery_types"
																						class="form-select">
																						<option value="">Chọn loại pin</option>
																						<c:forEach var="entry"
																				...
																				<div class="form-group">
																					<label class="control-label">Độ phân giải
																						màn hình</label> <select name="screen_resolution.ID"
																						id="screen_resolutions" class="form-select">
																						<option value="">Chọn độ phân giải</option>
																						<c:forEach var="entry"
																				...
																				<div class="form-group">
																					<label class="control-label">Chip đồ họa</label> <select
																						name="graphics_chip.ID" id="graphics_chips"
																						class="form-select">
																						<option value="">Chọn chip đồ họa giải</option>
																						<c:forEach var="entry"
																			...
																			<div class="col-md-4">
																				<div class="form-group ">
																					<label class="control-label">Chiều rộng(mm)</label>
																					<input min="0" max="300" name="WIDTH" type="number"
																						class="form-control" value="${item.WIDTH}" /> <span
																						id="${item.ID}WIDTH_errorss" class="text-danger"></span>
																				</div>
																				<div class="form-group ">
																					<label class="control-label">Chiều dài(mm)</label>
																				...
																				<div class="form-group ">
																					<label class="control-label">Chiều cao(mm)</label>
																				...
																				<div class="form-group ">
																					<label class="control-label">Kích thước
																						màng hình(inch)</label> <input name="SCREEN_SIZE"
																						min="0" max="12"
																				...
																				<div class="form-group ">
																					<label class="control-label">Trọng
																						lượng(gam)</label> <input name="WEIGHT" type="number"
																						min="0" max="500"
																						step="any" class="form-control"
																						value="${item.WEIGHT}" /> <span
																						id="${item.ID}WEIGHT_errorss" class="text-danger"></span>
																				</div>
																				<div class="form-group ">
																					<label class="control-label">Dung lượng(mA)</label>
																				...
																				<div class="form-group ">
																					<label class="control-label">Tần số làm
																						mới(hz)</label> <input 
																						min="0" max="300"
																						name="REFRESH_RATE" type="number"
																						step="any" class="form-control"
																						value="${item.REFRESH_RATE}" /> <span
																						id="${item.ID}REFRESH_RATE_errorss"
																						class="text-danger"></span>
																				</div>
																				<div class="form-group ">
																				...
																				<div class="form-group ">
																					<label class="control-label">Camera
																						trước(MP)</label> <input 
																						min="0" max="300"
																						name="SELFIE_CAMERA"
																						type="number" step="any" class="form-control"
																						value="${item.SELFIE_CAMERA}" /> <span
																						id="${item.ID}SELFIE_CAMERA_errorss"
																						class="text-danger"></span>
																				</div>
																				<div class="form-group ">
																					<label class="control-label">Camera sau(MP)</label>
																			...
																			<div class="col-md-4">
																				...
																				<div class="form-group">
																					<img id="previewImg1_${item.ID}" alt=""
																						...
																						src="/images/${item.IMAGE}"> <label
																						class="control-label">Ảnh chính</label> <input
																				...
																				<c:forEach var="image" items="${item.images}"
																					...
																					<div class="form-group">
																						<input type="hidden" name="image"
																							...
																							id="previewImg${index.index +1}_${item.ID}"
																							alt="" height="100px" width="100px"
																							src="/images/${image.IMAGE}"> <label
																							class="control-label">Ảnh
																							${index.index+1}</label> <input
																							id="imageInput${index.index +1}_${item.ID}"
																							name="anhUpdate" type="file"
																...
																<div class="accordion-body">
																	<div class="row">
																			...
																			<tbody>
																				<c:forEach var="variant" items="${item.variants}"
																					...
																					<tr>
																						...
																						<jsp:useBean id="today" class="java.util.Date"
																							scope="page" />
																						<fmt:formatDate var="currentDate" value="${today}"
																							pattern="yyyy-MM-dd" />
																						<fmt:formatDate var="expiryDate"
																							value="${variant.discount_product.EXPIRY_DATE}"
																							pattern="yyyy-MM-dd" />
																						<fmt:formatDate var="discount_product"
																							value="${item.CREATE_AT}" pattern="yyyyMMdd" />
																						<td>BT${discount_product}${stt.index +1}</td>
																						<td>
                                                                                ...
                                                                                ${variant.QUANTITY }</fmt:formatNumber></td>
																						<td><fmt:formatNumber type="currency"
																								currencyCode="VND" value="${variant.PRICE}" /></td>
																						...
																						<div class="modal fade"
																							id="updatebienthe${variant.ID}" tabindex="-1"
																												...
																												<div class="form-group">
																													...
																													<div class="form-group">
																														<label class="control-label">Mã
																															biến thể</label> <input type="text"
																															class="form-control" disabled
																															value="BT${formattedCreateAt}${variant.ID}">
																													</div>

																													<label class="control-label">Mã
																														phone</label> <input type="text" disabled
																						...
																						<!-- Modal deletebienthe-->
																						<div class="modal fade"
																							id="deletebienthe${variant.ID}" tabindex="-1"
																							...
																							<div class="modal-dialog">
																								<div class="modal-content">
																									<div class="modal-header">
																										<h1 class="modal-title fs-5"
																											id="deletebientheLabel">Xác nhận xóa
																											biến thể</h1>
																										<button type="button" class="btn-close"
																											data-bs-dismiss="modal" aria-label="Close"></button>
																									</div>
																		...
																		<button type="button" class="btn btn-primary"
																			...
																			biến thể mới</button>
																		<!-- Modal Thêm biến thể -->
																		<div div class="modal fade" id="thembienthe${item.ID}"
