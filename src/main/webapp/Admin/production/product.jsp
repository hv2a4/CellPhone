										...
										<div class="row text-left">
											<div class="col-md-4">
												...
												<div class="form-group">
													...
													<form:select path="category" class="form-select">
														<form:options items="${list_category}" itemLabel="NAME"
															itemValue="ID" />
													</form:select>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<form:select path="charging_port" class="form-select">
														<form:options items="${list_charging_port}"
												...
												<div class="form-group">
													...
													<form:select path="headphone_jack" class="form-select">
														<form:options items="${list_headphone_jack}"
															itemLabel="NAME" itemValue="ID" />
													</form:select>
												</div>
												<div class="form-group">
													...
													<form:select path="battery_type" class="form-select">
														<form:options items="${list_battery_type}"
															itemLabel="NAME" itemValue="ID" />
													</form:select>
												</div>
												<div class="form-group">
													...
													<form:select path="screen_resolution" class="form-select">
														<form:options items="${list_screen_resolution}"
															itemLabel="NAME" itemValue="ID" />
													</form:select>
												</div>
												<div class="form-group">
													...
													<form:select path="graphics_chip" class="form-select">
														<form:options items="${list_graphics_chip}"
															itemLabel="NAME" itemValue="ID" />
													</form:select>
												</div>
												<div class="form-group ">
													<label class="control-label">Chip</label>
													<form:input path="PROCESSOR" type="text"
														class="form-control" />
												</div>
												<div class="form-group ">
													<label class="control-label">Quay video</label>
													<form:input path="VIDEO_RECORDING" type="text"
														class="form-control" />
												</div>
												<div class="form-group ">
													<label class="control-label">Kết nối</label>
													<form:input path="CONNECTION" type="text"
														class="form-control" />
												</div>
												<div class="form-group ">
												...
												<div class="form-group ">
													...
													<form:input path="SCREEN_RESOLUTIONKT" type="text"
														class="form-control" placeholder="1080x2340"/>
												</div>
											...
											<div class="col-md-4">
												...
												<div class="form-group ">
													...
													<form:input path="SCREEN_SIZE" type="number"
														class="form-control" />
												</div>
												<div class="form-group ">
												...
												<div class="form-group ">
													...
													<form:input path="BATTERY_CAPACITY" type="number"
														class="form-control" />
												</div>
												<div class="form-group ">
												...
												<div class="form-group ">
													...
													<form:input path="REFRESH_RATE" type="number"
														class="form-control" />
												</div>
												<div class="form-group ">
													<label class="control-label">Độ sáng</label>
													<form:input path="MAXIMUM_BRIGHTNESS" type="number"
														class="form-control" />
												</div>
												<div class="form-group ">
													<label class="control-label">Tốc độ CPU</label>
													<form:input path="CPU_SPEED" type="number"
														class="form-control" />
												</div>
												<div class="form-group ">
													<label class="control-label">Camera trước</label>
													<form:input path="SELFIE_CAMERA" type="number"
														class="form-control" />
												</div>
												<div class="form-group ">
													<label class="control-label">Camera sau</label>
													<form:input path="MAIN_CAMERA" type="number"
														class="form-control" />
												</div>
											</div>
											<div class="col-md-4">
																	...
																	<form class="form-horizontal form-label-left">
																		<div class="row text-left">
																			<div class="col-md-4">
																				...
																				<div class="form-group">
																					<label class="control-label">Charging port</label>
																					<select name="charging-port" class="form-select">
																			...
																			<div class="col-md-4">
																				...
																				<div class="form-group ">
																					<label class="control-label">Kích thước
																						màng hình</label> <input type="text" class="form-control">
																				</div>
																				<div class="form-group ">
	...
	<script>
		$(document).ready(function() {
			$('input[type="file"]').on('change', function(e) {
				...
				var imgId = inputId.replace("imageInput", "previewImg"); // Tạo id tương ứng của thẻ img
				var reader = new FileReader();

				reader.onload = function(e) {
					$('#' + imgId).attr('src', e.target.result); // Cập nhật src của thẻ img
				}
