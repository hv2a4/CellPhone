                        ...
                        <div class="col-sm-12">
                            <div class="card-box table-responsive">
                                <table id="datatable-responsive"
                                    ...
                                    <tbody>
                                    <c:forEach items="${list_discount_code}" var="item" varStatus="loop">
                                        <tr>
                                            <td>${loop.index +1 }</td>
                                            <td>${item.CODE }</td>
                                            ...
                                            <td><fmt:formatNumber pattern="###">
                                                ${item.PERCENTAGE }</fmt:formatNumber> %
                                            </td>
                                            <td><fmt:formatNumber pattern="###,###">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <form:input id="percentage" type="text"
                                                                            class="form-control" path="PERCENTAGE"
                                                                            placeholder=""/>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <form:input id="minimun" type="text"
                                                                            class="form-control" path="MINIMUM"
                                                                            placeholder=""/>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="control-label">Số lượng</label>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <form:input id="start_date" type="date"
                                                                            class="form-control" path="START_DATE"
                                                                            placeholder=""/>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="control-label">Ngày kết thúc</label>
