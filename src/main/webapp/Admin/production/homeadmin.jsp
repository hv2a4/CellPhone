...
<body class="nav-md">
	...
	<script src="/Admin/vendors/datatables.net-fixedheader/js/dataTables.fixedHeader.min.js">
	</script> <script
	...
	<script src="/Admin/vendors/jszip/dist/jszip.min.js"></script> <script
		src="/Admin/vendors/pdfmake/build/pdfmake.min.js"></script> <script
		src="/Admin/vendors/pdfmake/build/vfs_fonts.js"></script>
</body>
</html>