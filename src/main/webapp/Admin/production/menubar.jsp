			...
			<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
				<div class="menu_section">
					...
					<ul class="nav side-menu">
						...
						<li class="border-top"><a href="/admin/user">Quản lý người
								dùng</a></li>
						...
						<li><a class="border-top" href="/admin/color">Quản lý màu</a></li>
						...
						<li><a href="/admin/charging_technology">Quản lý công nghệ sạc</a></li>
