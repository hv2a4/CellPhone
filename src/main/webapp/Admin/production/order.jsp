        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="trahang-tab" data-bs-toggle="tab"
                        ...
                        aria-controls="contact-tab-pane" aria-selected="false">Trả hàng
                </button>
            </li>
            <li class="nav-item" role="presentation">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${item.status_order.STATUS == 'Hoàn thành'}">
                                                                    <span class="badge rounded-pill"
                                                                          style="width: 100px; background-color: #4caf50; color: white;">
                                                                        Hoàn thành
                                                                    </span>
                                                                </c:when>
                                                                <c:when test="${item.status_order.STATUS == 'Chờ xác nhận'}">
                                                                    <span class="badge rounded-pill"
                                                                          style="width: 100px; background-color: #ffeb3b; color: black;">
                                                                        Chờ xác nhận
                                                                    </span>
                                                                </c:when>
                                                                <c:when test="${item.status_order.STATUS == 'Đã xác nhận'}">
                                                                    <span class="badge rounded-pill"
                                                                          style="width: 100px; background-color: #2196f3; color: white;">
                                                                        Đã xác nhận
                                                                    </span>
                                                                </c:when>
                                                                <c:when test="${item.status_order.STATUS == 'Giao hàng'}">
                                                                    <span class="badge rounded-pill"
                                                                          style="width: 100px; background-color: #ff9800; color: white;">
                                                                        Giao hàng
                                                                    </span>
                                                                </c:when>
                                                                <c:when test="${item.status_order.STATUS == 'Hủy'}">
                                                                    <span class="badge rounded-pill"
                                                                          style="width: 100px; background-color: #f44336; color: white;">
                                                                        Hủy
                                                                    </span>
                                                                </c:when>
                                                                <c:when test="${item.status_order.STATUS == 'Trả hàng'}">
                                                                    <span class="badge rounded-pill"
                                                                          style="width: 100px; background-color: #9e9e9e; color: white;">
                                                                        Trả hàng
                                                                    </span>
                                                                </c:when>
                                                            </c:choose>
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${item.status_order.STATUS == 'Hoàn thành'}">
                                                                    <button type="button" class="btn"
                                                                            ...
                                                                            style="width: 150px; background-color: #28a745; color: white;">
                                                                        Chi tiết
                                                                    </button>
                                                                </c:when>
                                                                <c:when test="${item.status_order.STATUS == 'Chờ xác nhận'}">
                                                                    <a class="btn" href="/admin/confirmation/${item.ID}"
                                                                       style="width: 150px; background-color: #ffc107; color: black;">
                                                                        Xác Nhận
                                                                    </a>
                                                                </c:when>
                                                                <c:when test="${item.status_order.STATUS == 'Đã xác nhận'}">
                                                                    <a type="button" class="btn"
                                                                       ...
                                                                       style="width: 150px; background-color: #17a2b8; color: whitesmoke;">
                                                                        Giao Hàng
                                                                    </a>
                                                                </c:when>
                                                                <c:when test="${item.status_order.STATUS == 'Giao hàng'}">
                                                                    <a class="btn" href="/admin/completed/${item.ID}"
                                                                       style="width: 150px; background-color: #007bff; color: white;">
                                                                        Hoàn Thành
                                                                    </a>
                                                                </c:when>
                                                                <c:when test="${item.status_order.STATUS == 'Hủy'}">
                                                                    <button type="button" class="btn"
                                                                            ...
                                                                            style="width: 150px; background-color: #dc3545; color: white;">
                                                                        Xem lý do
                                                                    </button>
                                                                </c:when>
                                                                <c:when test="${item.status_order.STATUS == 'Trả hàng'}">
