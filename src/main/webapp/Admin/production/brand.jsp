						...
						<div class="modal-dialog modal-lg">
							<div class="modal-content">
								<div class="modal-header">
									<h1 class="modal-title fs-5" id="themLabel">Thêm hãng mới</h1>
		...
		function modelDelete(id) {
		    $.ajax({
		        ...
		        success: function(brand) {
	                ...
	                $("#thongbao").text("Bạn có muốn xóa hãng " + brand.name);
	                var modal = new bootstrap.Modal(document.getElementById('delete'));
	                modal.show();
	                
	                // Xử lý khi nhấn nút Delete
	                $("#deleteButton").on("click", function() {
	                    window.location.href = "/admin/brand/delete?id=" + brand.id;
	                });
		        },
		        error: function(xhr, status, error) {
		            console.log("Error: " + error);
