        ...
        <div class="row">
          ...
          <div class="col-md-5">
            <div class="product-details">
              <h2 class="product-name">Iphone 15 Pro Max</h2>
              <div>
              ...
              <div>
                <h3 class="product-price">
                  30.000.000đ <del class="product-old-price">24.000.000đ</del>
                </h3>
              </div>
              <p>
                Mô tả sản phẩm
          ...
          <div class="col-md-3">
            <div class="product">
              ...
              <div class="product-body">
                ...
                <h3 class="product-name"><a href="/shop/product">Iphone 15 pro max</a></h3>
                <button type="button" class="btn btn-default">64GB</button>
                <button type="button" class="btn btn-default">258GB</button>
                <h4 class="product-price">
                  30,000,000 đ<del class="product-old-price">35,000,000 đ</del>
                </h4>
                <div class="product-rating">
                  <i class="fa fa-star"></i>
                  <i class="fa fa-star"></i>
                ...
                <div class="product-btns">
                  <button class="quick-view">
                    <a href="/shop/product"><i class="fa fa-eye"></i></a
                    ><span class="tooltipp">quick view</span>
                  </button>
                  <button class="quick-view">
                  <a href="/shop/cart"><i class="fa fa-shopping-cart"></i>
                  <span class="tooltipp">Thêm vào giỏ hàng</span></a>
                  </button>
                </div>
              </div>
              <div class="add-to-cart">
