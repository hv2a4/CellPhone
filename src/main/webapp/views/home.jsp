									...
									<div class="products-slick" data-nav="#slick-nav-1">
										...
										<div class="product">
											...
											<div class="product-body">
												...
												<h3 class="product-name"><a href="#">Iphone 15 pro max</a></h3>
												<button type="button" class="btn btn-default">64GB</button>
												<button type="button" class="btn btn-default">258GB</button>
												<h4 class="product-price">30,000,000 đ<del
														class="product-old-price">35,000,000 đ</del></h4>
												...
												<button class="quick-view"><a href="/shop/product"><i class="fa fa-eye"></i></a><span
														class="tooltipp">quick view</span></button>
													<button class="quick-view">
														<i class="fa fa-shopping-cart"></i><span class="tooltipp">Thêm vào giỏ hàng</span>
													</button>
												</div>
											</div>
											<div class="add-to-cart">
												<a href="/shop/checkout">
												<button class="add-to-cart-btn"><i class="fa-brands fa-bitcoin"
													style="font-size: 20px;"></i> Mua ngay</button></a>
											</div>
										</div>
										<div class="product">
											<div class="product-img">
											...
											<div class="product-body">
												...
												<div class="product-btns">
												<button class="quick-view"><a href="product.html?id=1"><i class="fa fa-eye"></i></a><span
														class="tooltipp">quick view</span></button>
													<button class="quick-view">
														<i class="fa fa-shopping-cart"></i><span class="tooltipp">Thêm vào giỏ hàng</span>
													</button>
